...
Wget -nc downloads the file, but not replicated if it already is downloaded. 
...
arch
```
**Indicates the arch of the computer (32-bit system)**

```{bash}
uname -a
```
**Gives you more details of the local computer system**
...
w
```
**Seems to give you more information on the users and what they're doing**
...
**Solution** Here is the [picture](https://drive.google.com/file/d/15_cgNaiddl9u8btlhf_dY5PF1whKVtRp/view)
