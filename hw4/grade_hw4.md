...
### Completeness, correctness and efficiency of solution: 195/200
...
- Q2 (95/100)
    ...
    - For demographic summary (`insurance` and `marital_status`), labeling and coloring look redundant because these are in the x-axis. `+0.0`
...
-   Are the folders (`hw1`, `hw2`, ...) created correctly? 
    ...
    -  No. `homework4` was created instead. This makes inconsistent with `grading`. `-5.0`
...
-   If necessary, are there clear instructions, either in report or in a separate file, how to reproduce the results?
    ...
    - `"~/Desktop/203b-HW/homework4/"` does not work for others. `-5.0`

    - We assume you are in `mimiciv_shiny` so you can just use `satoken <- "biostat-203b-2025-winter-4e58ec6e5579.json"` and `"mimic_icu_cohort.rds"`
