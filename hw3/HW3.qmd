...
ggplot(mimic_icu_cohort, aes(x = Creatinine, y = los )) +
  ...
  labs(title = "Length of ICU Stay vs Creatinine", x = "Creatinine (mg/dL)", y = "LOS (days)") +
  theme_minimal()
```
...
ggplot(mimic_icu_cohort, aes(x = Potassium, y = los )) +
  geom_point(alpha = 0.5, color = "red") +
  labs(title = "Length of ICU Stay vs Creatinine", x = "Potassium (mg/dL)", y = "LOS (days)") +
  theme_minimal()
```
...
ggplot(mimic_icu_cohort, aes(x = Sodium, y = los )) +
  geom_point(alpha = 0.5, color = "red") +
  labs(title = "Length of ICU Stay vs Creatinine", x = "Sodium (mg/dL)", y = "LOS (days)") +
  theme_minimal()
```
...
ggplot(mimic_icu_cohort, aes(x = Chloride, y = los )) +
  geom_point(alpha = 0.5, color = "red") +
  labs(title = "Length of ICU Stay vs Creatinine", x = "Chloride (mg/dL)", y = "LOS (days)") +
  theme_minimal()
```
...
ggplot(mimic_icu_cohort, aes(x = Bicarbonate, y = los )) +
  geom_point(alpha = 0.5, color = "red") +
  labs(title = "Length of ICU Stay vs Creatinine", x = "Bicarbonate (mg/dL)", y = "LOS (days)") +
  theme_minimal()
```
...
ggplot(mimic_icu_cohort, aes(x = Hematocrit, y = los )) +
  geom_point(alpha = 0.5, color = "red") +
  labs(title = "Length of ICU Stay vs Creatinine", x = "Hematrocrit (mg/dL)", y = "LOS (days)") +
  theme_minimal()
```
...
ggplot(mimic_icu_cohort, aes(x = Glucose, y = los )) +
  geom_point(alpha = 0.5, color = "red") +
  labs(title = "Length of ICU Stay vs Creatinine", x = "Glucose (mg/dL)", y = "LOS (days)") +
  theme_minimal()
```
...
ggplot(mimic_icu_cohort, aes(x = WBC, y = los )) +
  geom_point(alpha = 0.5, color = "red") +
  labs(title = "Length of ICU Stay vs Creatinine", x = "WBC (mg/dL)", y = "LOS (days)") +
  theme_minimal()
```
