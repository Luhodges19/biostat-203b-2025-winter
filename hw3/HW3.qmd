...
ln -sf ~/mimic/hosp/part-0.parquet part-0.parquet
...
ggplot(mimic_icu_summary, aes(x = fct_infreq(race), y = mean_los)) +
  ...
  labs(title = "Average Length of ICU Stay vs Race", x = "Race", y = "LOS (days)") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
```
**LOS vs. Insurance**
...
ggplot(mimic_icu_cohort, aes(x = fct_infreq(insurance), y = los)) +
  geom_col(fill = "pink") +
  labs(title = "Length of ICU Stay vs Insurance Type", x = "Insurance", y = "LOS (days)") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
```
...
ggplot(mimic_icu_cohort, aes(x = fct_infreq(marital_status), y = los)) +
  geom_col(fill = "pink") +
  labs(title = "Length of ICU Stay vs Marital Status", x = "Marital Status", y = "LOS (days)") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
ggplot(mimic_icu_cohort, aes(x = gender, y = los)) +
  ...
  labs(title = "Length of ICU Stay vs Gender", x = "Gender", y = "LOS (days)") +
  theme_minimal()
...
ggplot(mimic_icu_cohort, aes(x = anchor_age, y = los)) +
  geom_col(fill = "pink") +
  labs(title = "Length of ICU Stay vs Age", x = "Age at Admission", y = "LOS (days)") +
  theme_minimal()
...
ggplot(mimic_icu_cohort, aes(x = Potassium, y = los )) +
  geom_col(color = "pink") +
  labs(title = "Length of ICU Stay vs Potassium", x = "Potassium (mg/dL)", y = "LOS (days)") +
  theme_minimal()
```
...
ggplot(mimic_icu_cohort, aes(x = Sodium, y = los )) +
  geom_col(color = "pink") +
  labs(title = "Length of ICU Stay vs Sodium", x = "Sodium (mg/dL)", y = "LOS (days)") +
  theme_minimal()
```
...
ggplot(mimic_icu_cohort, aes(x = Chloride, y = los )) +
   geom_col(color = "pink") +
  labs(title = "Length of ICU Stay vs Chloride", x = "Chloride (mg/dL)", y = "LOS (days)") +
  theme_minimal()
```
...
ggplot(mimic_icu_cohort, aes(x = Bicarbonate, y = los )) +
   geom_col(color = "pink") +
  labs(title = "Length of ICU Stay vs Bicarbonate", x = "Bicarbonate (mg/dL)", y = "LOS (days)") +
  theme_minimal()
```
...
ggplot(mimic_icu_cohort, aes(x = Hematocrit, y = los )) +
   geom_col(color = "pink") +
  labs(title = "Length of ICU Stay vs Hematocrit", x = "Hematrocrit (mg/dL)", y = "LOS (days)") +
  theme_minimal()
```
...
ggplot(mimic_icu_cohort, aes(x = Glucose, y = los )) +
   geom_col(color = "pink") +
  labs(title = "Length of ICU Stay vs Glucose", x = "Glucose (mg/dL)", y = "LOS (days)") +
  theme_minimal()
```
...
ggplot(mimic_icu_cohort, aes(x = WBC, y = los )) +
   geom_col(color = "pink") +
  labs(title = "Length of ICU Stay vs White Blood Cell", x = "WBC (mg/dL)", y = "LOS (days)") +
  theme_minimal()
```
...
ggplot(mimic_icu_cohort, aes(x = Heart_Rate, y = los )) +
   geom_col(color = "pink") +
  labs(title = "Length of ICU Stay vs Heart_Rate", x = "Heart_Rate", y = "LOS (days)") +
  theme_minimal() +
...
```{r}
ggplot(mimic_icu_cohort, aes(x = SysBP, y = los )) +
   geom_col(color = "pink") +
  labs(title = "Length of ICU Stay vs SysBP", x = "SysBP", y = "LOS (days)") +
  theme_minimal() +
...
```{r}
ggplot(mimic_icu_cohort, aes(x = DiaBP, y = los )) +
   geom_col(color = "pink") +
  labs(title = "Length of ICU Stay vs DiaBP", x = "DiaBP", y = "LOS (days)") +
  theme_minimal() +
  coord_cartesian(xlim = c(0, 250)
  )
```
...
```{r}
ggplot(mimic_icu_cohort, aes(x = Temp, y = los )) +
   geom_col(color = "pink") +
  labs(title = "Length of ICU Stay vs Temp", x = "Temp", y = "LOS (days)") +
  theme_minimal() +
...
ggplot(mimic_icu_cohort, aes(x = Respiratory_Rate, y = los )) +
   geom_col(color = "pink") +
  labs(title = "Length of ICU Stay vs Respiratory_Rate", x = "Respiratory_Rate", y = "LOS (days)") +
  theme_minimal() +
  coord_cartesian(xlim = c(0, 200)
  )
```
...
ggplot(mimic_icu_cohort, aes(x = fct_infreq(first_careunit), y = los )) +
   geom_col(color = "pink") +
  labs(title = "Length of ICU Stay vs first_careunit", x = "first_careunit", y = "LOS (days)") +
  theme_minimal()+
